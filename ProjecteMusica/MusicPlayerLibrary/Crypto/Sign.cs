...
namespace MusicPlayerLibrary.Crypto
{
    public class Sign
    {
        ...
        /// <summary>
        /// Firma un archivo PDF utilizando un certificado digital proporcionado.
        /// </summary>
        /// <param name="certPath">Ruta del archivo del certificado digital.</param>
        /// <param name="certPass">Contraseña asociada al certificado digital.</param>
        /// <param name="output">Ruta de salida para el archivo PDF firmado.</param>
        /// <param name="PdfRoute">Ruta del archivo PDF que se va a firmar.</param>
        public void CreateSignPDF(String certPath, String certPass, String output, String PdfRoute)
        {
            // Utilizando el certificado digital proporcionado
            using (X509Certificate2 cert = new X509Certificate2(certPath, certPass))
            {
                ...
                // Inicializa el certificado digital
                InitCertificate(certPath, certPass);

                // Firma el archivo PDF
